...
def main():
	while True:
		# 获取格林威治格式化时间并且减去30分钟(最新的图片可能获取不到)		
		...
		img_url = "http://himawari8-dl.nict.go.jp/himawari8/img/D531106/1d/550/" + realtime_strf + "00_0_0.png"
		...
		while not downloadImg(img_url, img_name, img_path):
			pass
		setDesktopBackground(img_path)
